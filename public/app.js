const I18N = {
  zh: {
    ...
    guideTourButton: "引导",
    backToTop: "返回顶部",
    siteFooterLabel: "站点信息",
    siteFooterLinksLabel: "官网、代码仓库与备案信息",
    siteFooterCopyright: "© 2026 星仓印记 StarVault Imprint",
    siteFooterOfficialSite: "官网",
    siteFooterRepository: "GitHub 仓库",
    guideTourClose: "关闭引导",
    guideTourPrev: "上一步",
    guideTourNext: "下一步",
    guideTourFinish: "完成",
  ...
  en: {
    ...
    siteFooterLabel: "Site information",
    siteFooterLinksLabel: "Official site, repository, and filing information",
    siteFooterCopyright: "© 2026 StarVault Imprint",
    siteFooterOfficialSite: "Official site",
    siteFooterRepository: "GitHub repository",
