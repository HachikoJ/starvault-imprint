const I18N = {
  zh: {
    ...
    siteFooterLinksLabel: "访问入口",
    siteFooterCopyright: "© 2026 星仓印记 · MIT 开源",
    siteFooterOfficialSite: "访问官网",
    siteFooterRepository: "访问 GitHub",
    guideTourClose: "关闭引导",
    guideTourPrev: "上一步",
    guideTourNext: "下一步",
    guideTourFinish: "完成",
  ...
  en: {
    ...
    siteFooterLinksLabel: "Resources",
    siteFooterCopyright: "© 2026 StarVault Imprint · MIT open source",
    siteFooterOfficialSite: "Visit official site",
    siteFooterRepository: "Visit GitHub",
