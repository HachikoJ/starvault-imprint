...
| D-008 | 真实 Pages 地址可访问且部署产物与本地验收一致 | 部署后打开 `https://hachikoj.github.io/starvault-imprint/` | Pass - 2026-09-16 Actions 发布成功（含返回顶部版本的 run `35079291722`）；线上页面返回 200，桌面和移动端全新浏览器均装载 `demo-content`、25 个项目、20 条榜单和 1 条扫描，横向溢出、console、失败请求与 HTTP 错误均为 0。 |
